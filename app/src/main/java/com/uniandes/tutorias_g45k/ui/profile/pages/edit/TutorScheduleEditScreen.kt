...
@Composable
fun TutorScheduleEditScreen(
    viewModel: TutorScheduleEditViewModel=viewModel(),
    onSuccess: () -> Unit,
    onBack: () -> Unit
) {
    ...
    Scaffold(
                ...
                AnimatedVisibility(
                    ...
                    Surface(
                        ...
                        Row(
                            ...
                            Text(
                                text = "Sin conexión a Internet. Restablecer conexión para poder actualizar",
        ...
        bottomBar = {
            Button(
                onClick = {viewModel.saveAvailability(onSuccess)},
                modifier = Modifier
                    .fillMaxWidth()
                    .height(72.dp)
                ...
                if (uiState.isLoading) {
                    ...
                    Text(if (isOnline) "Actualizar Disponibilidad" else "Sin conexión para publicar", fontWeight = FontWeight.Bold)
                }
            }
        }
    ) { padding ->
